//! Hipocampo Core - Memory Trait Definitions
//!
...
pub trait Memory: Send + Sync {
    ...
    async fn search(&self, query: &str, opts: SearchOptions) -> anyhow::Result<Vec<MemoryEntry>>;

    /// Get a specific memory by key
    async fn get(&self, key: &str) -> anyhow::Result<Option<MemoryEntry>>;

    /// List memories with optional filters
    async fn list(&self, filter: ListFilter) -> anyhow::Result<Vec<MemoryEntry>>;
